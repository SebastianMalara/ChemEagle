...
export function IngestView() {
  const [experimentName, setExperimentName] = useState("ChemEagle Review Experiment");
  ...
  const [status, setStatus] = useState("Queue a live batch or sideload a previous JSON run.");
    ...
    <section className="page">
      <header className="page-hero">
        <div className="hero-copy">
          ...
          <h2>Queue live comparison runs or sideload previous JSON outputs.</h2>
          <p className="hero-text">
            Browser uploads handle source files while manual path fields keep the
            server-local workflow available for folders and recovery roots.
          </p>
        </div>
      ...
      <div className="page-grid">
        <form className="panel panel-stack" onSubmit={handleLiveSubmit}>
        ...
        <form className="panel panel-stack" onSubmit={handleSideloadSubmit}>
          <div className="panel-header">
            <div>
